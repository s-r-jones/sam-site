        ...
        <div className="content-container">
          <div className="card">
            ...
            <div className="card-description">
              I was a lead developer for Meow Wolf's super futuristic and fun
              website.
          ...
          <div className="card">
            ...
            <div className="card-description">
              ...
              throughout a day. Reduced time-to-purchase by 40seconds, increased
              conversions by 4 percent, and increased average purchase amount by
              10%.
              <div className="font-bold">Stack:</div>
              <div>Next.js, Graphql, TypeScript, Google Cloud Engine</div>
            </div>
          ...
          <div className="card">
            ...
            <div className="card-description">
              This web application was created for the New Mexico Department of
              Game and Fish with help from several researchers from the
          ...
          <div className="card">
            ...
            <div className="card-description">
              I worked as a lead developer on a team that designed and created
              an internal customer portal for FundX Investment Group. Through
              the portal users can monitor, add, and remove funds to their
              portfolio.
              <div className="font-bold">Stack:</div>
          ...
          <div className="card">
            ...
            <div className="card-description">
              Insights is a performance management platform designed to support
              success by connecting employees and aligning work around
              high-level company strategy and goals. Insights provides
              executives with the knowledge they need to see organization
              performance, and clarify actionable goals.
              <div className="font-bold">Stack:</div>
      ...
      {activeTab === 0 && (
        <div className="content-container">
          <div className="card">
            ...
            <div className="card-description">
              Wear a wobbly rainbow helmet and watch magic jellies float around
              you. This effect has been viewed more than 17 Million times.
            </div>
            <div className="card-images max-w-sm mx-auto">
              <video src="jelly_demo.mov" height="40" width="200" controls />
            </div>
          </div>
          ...
          <div className="card">
            ...
            <div className="card-description">
              Up is down light is dark and dark is... rainbows? This effect has
              been viewed more than 1 million times and features a waving
              rippling fragment shader
            </div>
            <div className="card-images max-w-sm mx-auto">
              <video src="reflect_demo.mp4" height="40" width="200" controls />
            </div>
          </div>
          ...
          <div className="card">
            ...
            <div className="card-description">
              Party likw its 1995 and someone stuck a magnet on your VCR. This
              effect features a fuzzy and distorted fragment shader. This effect
